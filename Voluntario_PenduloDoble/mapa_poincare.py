...
x, y = load_data_from_file("C:/Users/Teresa/Desktop/COMPU/Fisica_Computacional/Voluntario_PenduloDoble/poincare_phi_psi_E1.0.txt")
x1, y1 = load_data_from_file("C:/Users/Teresa/Desktop/COMPU/Fisica_Computacional/Voluntario_PenduloDoble/poincare_phi_psi_E3.0.txt")
x2, y2 = load_data_from_file("C:/Users/Teresa/Desktop/COMPU/Fisica_Computacional/Voluntario_PenduloDoble/poincare_phi_psi_E5.0.txt")
x3, y3 = load_data_from_file("C:/Users/Teresa/Desktop/COMPU/Fisica_Computacional/Voluntario_PenduloDoble/poincare_phi_psi_E10.0.txt")
x4, y4 = load_data_from_file("C:/Users/Teresa/Desktop/COMPU/Fisica_Computacional/Voluntario_PenduloDoble/poincare_phi_psi_E15.0.txt")
#x5, y5 = load_data_from_file("C:/Users/Teresa/Desktop/COMPU/Fisica_Computacional/Voluntario_PenduloDoble/poincare_phi_psi_E20.0.txt")
...
plt.xlabel('$\phi$ (rad)')
plt.ylabel('$\psi$ (rad)')
plt.title('Mapa de Poincaré de $\phi$ y $\psi$, con  $\phi=0.2rad$ y $\psi=0.3rad$')
